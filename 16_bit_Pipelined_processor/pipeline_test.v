...
`ifdef tb1
   `define PAT_DM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test1/dm_data.txt"
   `define PAT_IM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test1/im_data.txt"
`endif

`ifdef tb2
   `define PAT_DM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test2/dm_data.txt"
   `define PAT_IM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test2/im_data.txt"
`endif

`ifdef tb3
   `define PAT_DM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test3/dm_data.txt"
   `define PAT_IM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test3/im_data.txt"
`endif

`ifdef tb4
   `define PAT_DM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test4/dm_data.txt"
   `define PAT_IM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test4/im_data.txt"
`endif

`ifdef tb5
   `define PAT_DM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test5/dm_data.txt"
   `define PAT_IM "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/sim/data/Test5/im_data.txt"
`endif

`ifdef RTL
   `include "/home/rain/VLSI_CAD_Project/16_bit_Pipelined_processor/pipelinedPS.v"
`endif

...
HD_PWD='C:/Users/User/Desktop/cad_project/custom_ISA_pipeline_processer/custom_ISA_pipeline_processer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipelinedPS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipelinedPS.tcl
